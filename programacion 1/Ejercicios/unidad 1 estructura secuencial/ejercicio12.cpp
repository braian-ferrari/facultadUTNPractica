...
int cajaDeHuevos;
int huevoSuelto;
int cantDehuevosComprada;
int importeTotalApagar;
int precioCajaDeHuevos = 1000;
int precioHuevoSuelto = 120;

cout<<"Ingrese la cantidad de huevos: "<<endl;
cin>>cantDehuevosComprada;

cajaDeHuevos = cantDehuevosComprada / 12;
huevoSuelto = cantDehuevosComprada % 12;

importeTotalApagar = (cajaDeHuevos*precioCajaDeHuevos) + (huevoSuelto*precioHuevoSuelto);

cout<<"el importe total a pagar es:$ "<<importeTotalApagar<<endl;
