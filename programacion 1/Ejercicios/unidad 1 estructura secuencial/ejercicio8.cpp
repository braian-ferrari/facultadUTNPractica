...
int importeVentaSinDescuento;
int importeVentaConDescuento;
float porcentaje;
...
porcentaje = importeVentaConDescuento * 100 / importeVentaSinDescuento;

porcentajeDescuento = 100 - porcentaje;

cout<<"el descuento aplicado es del: %"<<porcentajeDescuento<<endl;
